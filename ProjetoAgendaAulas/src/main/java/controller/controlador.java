...
public class controlador extends HttpServlet {
	...
	// método para inserir um novo contato - CREATE
	protected void novoContato(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {

		contato.setNome(request.getParameter("nome"));
		contato.setPeso(request.getParameter("peso"));
		contato.setÉspecie(request.getParameter("éspecie"));
		contato.setQualidadedaagua(request.getParameter("qualidadedaagua"));
	...
	protected void selecionarContato(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("peso", contato.getPeso());
		request.setAttribute("éspecie", contato.getÉspecie());
		request.setAttribute("qualidadedaagua", contato.getQualidadedaagua());
